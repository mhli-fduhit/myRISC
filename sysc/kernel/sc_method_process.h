...
//DM 05/28/2019 removed seg id argument in next_trigger()
  ...
  std::unordered_set<sc_method_process*> dependent_methods;
  std::vector<sc_method_process*> m_contingent_methods;
  std::unordered_set<sc_thread_process*> m_contingent_threads;

  std::unordered_set<sc_thread_process*> dependent_threads;

  std::unordered_set<sc_method_process*> combined_data_conflict_methods;
  std::unordered_set<sc_thread_process*> combined_data_conflict_threads;
