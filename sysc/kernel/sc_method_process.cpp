...
//
//------------------------------------------------------------------------------
bool sc_method_process::deliver_event_at_time( sc_event* e, 
...
{ 
    ...
    e->remove_dynamic( this); //DM 08/2019
        ...
        case OR_LIST:
        {
            ...
            */
            ...
            wake_up_time_for_event_list = sc_timestamp( e_delivery_time.get_time_count(),
                e_delivery_time.get_delta_count() +1);
            m_event_list_p->remove_all_dynamic( this);//DM 08/16/2019 experiment
            m_event_count = 0;
            m_event_list_p->auto_delete();
            m_event_list_p = 0;
            m_trigger_type = STATIC; //commented off by ZC 15:01 2018/7/8
